...
{
    [DbContext(typeof(InvoABPDbContext))]
    partial class InvoABPDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoABP.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvoABP.Invoices.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvoABP.Invoices.InvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InvoABP.Invoices.Invoice", b =>
                {
                    b.HasOne("InvoABP.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InvoABP.Invoices.InvoiceLine", b =>
                {
                    b.HasOne("InvoABP.Invoices.Invoice", null)
                        .WithMany("Lines")
